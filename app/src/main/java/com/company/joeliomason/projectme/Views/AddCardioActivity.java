...
public class AddCardioActivity extends AppCompatActivity implements ActionBar.TabListener {
    ...
    static AddCardioFragment1 fragmentFirst;
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    fragmentFirst = new AddCardioFragment1(); //modified
                    return fragmentFirst; //added
                case 1:
                    return new AddCardioFragment2();
            }
            return null;
        }
