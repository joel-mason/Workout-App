...
public class EditCardioActivity extends AppCompatActivity implements ActionBar.TabListener {
    ...
    EditCardioFragment1 fragmentFirst;
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    bundle.putInt("id", id);
                    fragmentFirst = new EditCardioFragment1();
                    return fragmentFirst;
                case 1:
                    return new EditCardioFragment2();
            }
            return null;
        }
